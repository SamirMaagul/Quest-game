...
// Не забудьте! Когда игрок начинает заново (в main.html или index.html),
// нужно обнулить прогресс: localStorage.setItem('playerHP', 100);
...
function addItem(itemName) {
  ...
  if (!inventory.includes(itemName)) {
    ...
    // Оповещаем игрока о находке
    alert("Вы подобрали предмет: " + itemName);
  }
}
